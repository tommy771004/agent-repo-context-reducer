...
NATIVE_CAPABILITIES = {
    ...
    "context.evidence-contract", "context.context-store", "context.recall", "context.claim-verification-recall", "context.stale-invalidation",
...
CORE_CAPABILITIES = {
    ...
    "context.provenance", "context.schema", "context.trust-boundary", "context.tokenizer",
    "context.candidate-detection", "context.deterministic-verifier", "context.git-provenance",
    "context.filter-pipeline", "context.provenance-dedup", "context.cross-layer-dedup",
...
CAPABILITY_HINTS: dict[str, tuple[str, ...]] = {
    ...
    "context.evidence-contract": ("context evidence", "repository evidence", "evidence contract"),
    "context.context-store": ("context store", "active context", "recallable context", "hot warm cold context"),
